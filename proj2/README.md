...
Use of syntax checkers. |3| https://github.com/csc510fall23g45/slash/blob/main/.github/workflows/pylint.yml |
Use of code coverage |3| https://github.com/csc510fall23g45/slash/blob/main/.github/workflows/code_cov.yml |
Other automated analysis tools |3| https://github.com/csc510fall23g45/slash/actions  |
Test cases exist |3| https://github.com/csc510fall23g45/slash/blob/main/tests/test_cli.py |
Test cases are routinely executed |3| https://github.com/csc510fall23g45/slash/actions  |
The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up |3| https://github.com/csc510fall23g45/slash/blob/main/CONTRIBUTING.md |
Issues are discussed before they are closed |3| https://github.com/csc510fall23g45/slash/issues |
Chat channel: exists |3| https://github.com/csc510fall23g45/slash#chat-channel |
Test cases: a large proportion of the issues related to handling failing cases. |3| https://github.com/csc510fall23g45/slash/issues |
Evidence that the whole team is using the same tools: everyone can get to all tools and files |3| https://github.com/csc510fall23g45/slash/graphs/contributors |
"Evidence that the whole team is using the same tools (e.g. config files in the repo updated by lots of different people) "|3| https://github.com/csc510fall23g45/slash/graphs/contributors |
"Evidence that the whole team is using the same tools "|3| https://github.com/csc510fall23g45/slash/graphs/contributors  |
Evidence that the members of the team are working across multiple places in the code base |3| https://github.com/csc510fall23g45/slash/graphs/contributors  |
Short release cycles |3| https://github.com/csc510fall23g45/slash/releases/tag/slash_v1.4.1  |
Q1 - What your software does |  | 
"1.1) Does your website and documentation provide a clear, high-level overview of your software? "|YES| https://github.com/csc510fall23g45/slash#slash
1.2) Does your website and documentation clearly describe the type of user who should use your software? |YES| https://github.com/csc510fall23g45/slash#thought_balloon-use-case
...
11.3) Do you provide publicly available instructions for deploying your software? |YES|https://github.com/csc510fall23g45/slash#rocket-quick-guide
