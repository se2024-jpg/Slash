...
8|Docs: doco generated , format not ugly|3 |https://github.com/SEProjGrp5/slash/tree/main/docs|
9|Docs: what: point descriptions of each class/function (in isolation) |3|https://github.com/SEProjGrp5/slash/blob/main/README.md|
10|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z|3|[Examples](https://github.com/SEProjGrp5/slash/blob/main/README.md#card_index_dividers-some-examples)|
11|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing|3|[Section in README](https://github.com/SEProjGrp5/slash#page_facing_up-why)|
12|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|3|https://github.com/SEProjGrp5/slash/blob/main/assets/demo.gif | 
...
28| Evidence that the members of the team are working across multiple places in the code base | 3 | https://github.com/SEProjGrp5/slash/graphs/contributors |
...
30| Documentation provides clear overview of software and uses | 3 | https://github.com/SEProjGrp5/slash#readme |
31| Website and documentation clearly describe the type of user who should use your software | 3 | https://github.com/SEProjGrp5/slash#readme |
...
36| Software available for free | 3 | Our repository is public and can be clone and used by anyone. (https://github.com/SEProjGrp5/slash) |
37| Source code publicly available to download, either as a downloadable bundle or via access to a source code repository | 3 | git clone https://github.com/SEProjGrp5/slash.git or Download as a zip file from here https://github.com/SEProjGrp5/slash/archive/refs/heads/main.zip |
38| Software hosted in an established, third-party repository likeGitHub (https://github.com) | 3 ||
39| Documentation clearly available within your software | 3 | https://github.com/SEProjGrp5/slash#readme |
40| Documentation includes a "quick start" guide, that provides a short overview of how to use your software with some basic examples of use | 3 | https://github.com/SEProjGrp5/slash#readme |
41| Providing more extensive documentation, that gives a clear, step-by-step instructions on how to deploy and use our software | 3 | https://github.com/SEProjGrp5/slash#readme |
42| Comprehensive guide to all your software’s commands, functions and options| 3 | We have defined one use case of each command or function that can be performed by our code. https://github.com/SEProjGrp5/slash#readme |
...
54| Software uses an accepted coding standard or convention | 3 | https://github.com/SEProjGrp5/slash/blob/main/CODE-OF-CONDUCT.md, https://github.com/SEProjGrp5/slash/blob/main/CONTRIBUTING.md |
...
61| Releases are tagged in the repository | 3 | https://github.com/SEProjGrp5/slash/releases/tag/v1.0.0 |
...
64| Provide publicly available instructions for building the software from the source code | 3| https://github.com/SEProjGrp5/slash/blob/main/README.md|
...
67| Documentation list all third-party dependencies | 3|https://github.com/SEProjGrp5/slash/blob/main/requirements.txt|
