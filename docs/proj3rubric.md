...
"Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing "|2|Readme: https://github.com/csc510fall23g45/slash/blob/main/README.md |
...
Chat channel: exists |3|(Link to be Added) |
...
Evidence that the members of the team are working across multiple places in the code base |3|https://github.com/TommasU/slash/graphs/contributors  |
Short release cycles |3|https://github.com/TommasU/slash/releases  |
